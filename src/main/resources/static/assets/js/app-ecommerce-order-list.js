      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              '<a href="app-ecommerce-order-details.go"><span class="fw-medium">#' + $order_id + '</span></a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<h6 class="m-0"><a href="pages-profile-user.go" class="text-body">' +
              $name +
              '</a></h6>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="app-ecommerce-order-details.go" class="dropdown-item">View</a>' +
