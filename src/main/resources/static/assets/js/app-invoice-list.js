      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              '<a href="app-invoice-preview.go"><span class="fw-medium">#' + $invoice_id + '</span></a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="pages-profile-user.go" class="text-body text-truncate"><span class="fw-medium">' +
              $name +
              '</span></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="app-invoice-preview.go" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show mx-1"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="app-invoice-edit.go" class="dropdown-item">Edit</a>' +
      ...
      buttons: [
        {
          ...
          action: function (e, dt, button, config) {
            window.location = 'app-invoice-add.go';
          }
        }
      ],
