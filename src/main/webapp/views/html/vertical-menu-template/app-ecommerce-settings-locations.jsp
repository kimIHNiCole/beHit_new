...
<html
  ...
  <head>
    ...
    <title>Settings Locations - eCommerce | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                  ...
                  <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                    <ul class="nav nav-align-left nav-pills flex-column">
                      <li class="nav-item mb-1">
                        <a class="nav-link" href="app-ecommerce-settings-detail.go">
                          <i class="bx bx-store me-2"></i>
                          <span class="align-middle">Store details</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link" href="app-ecommerce-settings-payments.go">
                          <i class="bx bxs-credit-card me-2"></i>
                          <span class="align-middle">Payments</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link" href="app-ecommerce-settings-checkout.go">
                          <i class="bx bx-cart me-2"></i>
                          <span class="align-middle">Checkout</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link" href="app-ecommerce-settings-shipping.go">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="app-ecommerce-settings-notifications.go">
                  ...
                  <div class="tab-content p-0">
                    ...
                    <div class="tab-pane fade show active" id="locations" role="tabpanel">
                          ...
                          <div class="alert d-flex align-items-center bg-label-info mb-0" role="alert">
                            ...
                            <div class="ps-1">
                              <span
                                ...
                                location, select another default location first.</span
                              >
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="d-flex justify-content-end gap-3">
                        ...
                        <a class="btn btn-primary" href="app-ecommerce-settings-notifications.go">Save</a>
                      </div>
                    </div>
                  </div>
                  <!-- /Options-->
