      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" action="auth-reset-password-cover.go" method="GET">
              <div class="mb-3">
            ...
            <div class="text-center">
              <a href="auth-login-cover.go" class="d-flex align-items-center justify-content-center">
