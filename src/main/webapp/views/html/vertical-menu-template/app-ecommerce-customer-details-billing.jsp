...
<html
  ...
  <head>
    ...
    <title>
      eCommerce Customer Details Address &amp; Billing - Pages | Sneat - Bootstrap 5 HTML Admin Template - Pro
    </title>
              ...
              <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="app-ecommerce-customer-details-security.go"
                          ...
                          <div
                            ...
                            <div class="d-flex gap-3 p-4 p-sm-0 pt-0 ms-1 ms-sm-0">
                              <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editCCModal"
                                ><i class="bx bx-pencil text-secondary fs-4"></i
                              ></a>
                              <a href="javascript:void(0);"><i class="bx bx-trash text-secondary fs-4"></i></a>
                              <button class="btn p-0" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                <i class="bx bx-dots-vertical-rounded text-secondary fs-4"></i>
