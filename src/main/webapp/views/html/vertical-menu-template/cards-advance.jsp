...
<html
  ...
  <head>
    ...
    <title>Cards Advance- UI elements | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">100h:</h6>
                                <span class="text-muted">138h</span>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">121h:</h6>
                                <span class="text-muted">109h</span>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">112h:</h6>
                                <span class="text-muted">160h</span>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">125h:</h6>
                                <span class="text-muted">166h</span>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">76h:</h6>
                                <span class="text-muted">89h</span>
                              </div>
                            </div>
                        ...
                        <li class="d-flex">
                          ...
                          <div class="d-flex w-100 align-items-start gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">22h:</h6>
                                <span class="text-muted">45h</span>
                              </div>
                            </div>
                    ...
                    <div class="card-body">
                      ...
                      <form id="paymentMethodForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="col-12">
                          ...
                          <div class="input-group input-group-merge">
                            <input
                              id="paymentAddCard"
                              name="paymentAddCard"
                              class="form-control credit-card-payment"
                              type="text"
                              placeholder="1356 3215 6548 7898"
                              aria-describedby="paymentAddCard2" />
                            <span class="input-group-text cursor-pointer p-1" id="paymentAddCard2"
                              ><span class="card-payment-type"></span
                            ></span>
                          </div>
                        </div>
                        <div class="col-12 col-md-6">
                          ...
                          <input
                            type="text"
                            id="paymentAddCardExpiryDate"
                            class="form-control expiry-date-payment"
                            placeholder="MM/YY" />
                        </div>
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            <input
                              type="text"
                              id="paymentAddCardCvv"
                              class="form-control cvv-code-payment"
                              maxlength="3"
                              placeholder="654" />
                            <span class="input-group-text cursor-pointer" id="paymentAddCardCvv2"
                              ><i
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <small class="fw-medium">$1,619</small><i class="bx bx-chevron-up text-success ms-1"></i>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <small class="fw-medium">$3,571</small><i class="bx bx-chevron-up text-success ms-1"></i>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <small class="fw-medium">$430</small><i class="bx bx-chevron-up text-success ms-1"></i>
                        ...
                        <li class="d-flex mb-4">
                          <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              ...
                              <small class="fw-medium">12.8%</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-4">
                          <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              ...
                              <small class="fw-medium">- 8.5% </small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-4">
                          <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <i class="bx bx-up-arrow-alt text-success me-2"></i>
                              <small class="fw-medium">9.12%</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-4">
                          <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <i class="bx bx-up-arrow-alt text-success me-2"></i>
                              <small class="fw-medium">2.83%</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex">
                          <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                              <i class="bx bx-up-arrow-alt text-success me-2"></i>
                              <small class="fw-medium">12.1%</small>
                            </div>
                          </div>
                        </li>
                      </ul>
