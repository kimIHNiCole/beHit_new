...
<html
  ...
  <head>
    ...
    <title>My Courses - Academy | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          <div class="rounded-2 text-center mb-3">
                            <a href="app-academy-course-details.go"
                              ><img
                                class="img-fluid"
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a href="app-academy-course-details.go" class="h5">Basics of Angular</a>
                            ...
                            <div class="d-flex flex-column flex-md-row gap-2 text-nowrap pe-xl-3 pe-xxl-0">
                              <a
                                ...
                                href="app-academy-course-details.go">
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a class="h5" href="app-academy-course-details.go">Figma & More</a>
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a class="h5" href="app-academy-course-details.go">Keyword Research</a>
                            <p class="mt-2">
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a class="h5" href="app-academy-course-details.go">Basics to Advanced</a>
                            <p class="mt-2">
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a class="h5" href="app-academy-course-details.go">Art & Drawing</a>
                            <p class="mt-2">
                            ...
                            <a class="w-100 btn btn-label-primary" href="app-academy-course-details.go"
                      ...
                      <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            ...
                            <a class="h5" href="app-academy-course-details.go">Basics Fundamentals</a>
