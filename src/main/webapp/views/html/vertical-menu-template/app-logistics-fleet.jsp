...
<html
  ...
  <head>
    ...
    <title>Fleet - Logistics | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="alert alert-primary alert-dismissible" role="alert">
                ...
                <a
                  href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/documentation//faq.go#mapbox-not-loading"
                  class="alert-link"
                  target="_blank"
                  >documentation</a
                >.
              ...
              <div class="card overflow-hidden">
                ...
                <div class="d-flex app-logistics-fleet-wrapper">
                  ...
                  <div class="flex-shrink-0 position-fixed m-4 d-md-none w-auto z-1">
                    <button
                      class="btn btn-label-white border border-2 z-2 p-2"
                  ...
                  <div class="app-logistics-fleet-sidebar col h-100" id="app-logistics-fleet-sidebar">
                    <div class="card-header border-0 pt-4 pb-2 d-flex justify-content-between">
                      ...
                      <i
                        class="bx bx-x bx-sm cursor-pointer close-sidebar d-md-none"
                        data-bs-toggle="sidebar"
                        data-overlay
