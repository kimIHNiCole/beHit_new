...
<html
  ...
  <head>
    ...
    <title>Cards Actions- UI elements | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                  ...
                  <div class="card card-action mb-4">
                    ...
                    <div class="collapse show">
                      <div class="card-body pt-0">
                        ...
                        <p class="card-text">
                          Click on <i class="tf-icons bx bx-chevron-up"></i> to see card collapse in action.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Click on <i class="tf-icons bx bx-rotate-left scaleX-n1-rtl"></i> icon to see refresh card
                        content in action.
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Click on <i class="tf-icons bx bx-fullscreen"></i> icon to see expand card in action.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <br />
                      <p class="card-text">
                        Click on <i class="tf-icons bx bx-x"></i> icon to see remove card in action.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-header header-elements">
                      ...
                      <div class="card-header-elements ms-auto">
                        <button type="button" class="btn btn-xs btn-primary">
                          <span class="tf-icon bx bx-plus bx-xs me-1"></span>Button
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
