...
<html
  ...
  <head>
    ...
    <title>Account settings - Security | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                        ...
                        <div class="col-md-12">
                          <div class="bg-lighter rounded p-3 mb-3 position-relative">
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <span class="me-2"
                                ><span class="fw-medium">23eaf7f0-f4f7-495e-8b86-fad3261282ac</span></span
                              >
                          ...
                          <div class="bg-lighter rounded p-3 position-relative mb-3">
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <span class="me-2"
                                ><span class="fw-medium">bb98e571-a2e2-4de8-90a9-2e231b5e99</span></span
                              >
                              <span class="text-light cursor-pointer"><i class="bx bx-copy"></i></span>
                            </div>
                          ...
                          <div class="bg-lighter rounded p-3 position-relative">
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <span class="me-2"
                                ><span class="fw-medium">2e915e59-3105-47f2-8838-6e46bf83b711</span></span
                              >
                              <span class="text-light cursor-pointer"><i class="bx bx-copy"></i></span>
                            </div>
