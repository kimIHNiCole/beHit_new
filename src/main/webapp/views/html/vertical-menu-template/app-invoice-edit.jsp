...
<html
  ...
  <head>
    ...
    <title>Edit - Invoice | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="d-flex my-3">
                        <a href="./app-invoice-preview.go" class="btn btn-label-secondary w-100 me-3">Preview</a>
                      ...
                      <button
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap"
                          ><i class="bx bx-dollar bx-xs me-1"></i>Add Payment</span
                        >
                      </button>
                    </div>
                  </div>
