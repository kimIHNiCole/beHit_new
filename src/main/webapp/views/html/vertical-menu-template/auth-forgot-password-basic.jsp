        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="auth-reset-password-basic.go" method="GET">
                <div class="mb-3">
              ...
              <div class="text-center">
                <a href="auth-login-basic.go" class="d-flex align-items-center justify-content-center">
