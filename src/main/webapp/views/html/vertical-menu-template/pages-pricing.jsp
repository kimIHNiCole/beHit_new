...
<html
  ...
  <head>
    ...
    <title>Pricing - Pages | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                      ...
                      <div class="col-lg mb-md-0 mb-4">
                        <div class="card border rounded shadow-none">
                          <div class="card-body">
                            ...
                            <a href="auth-register-basic.go" class="btn btn-label-success d-grid w-100"
                              >Your Current Plan</a
                            >
                          </div>
                        </div>
                      ...
                      <div class="col-lg mb-md-0 mb-4">
                        <div class="card border-primary border shadow-none">
                          <div class="card-body position-relative">
                            ...
                            <a href="auth-register-basic.go" class="btn btn-primary d-grid w-100">Upgrade</a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg">
                        <div class="card border rounded shadow-none">
                          <div class="card-body">
                            ...
                            <a href="auth-register-basic.go" class="btn btn-label-primary d-grid w-100">Upgrade</a>
                          </div>
                        </div>
                      </div>
                    </div>
