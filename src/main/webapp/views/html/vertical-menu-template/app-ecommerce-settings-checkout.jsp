...
<html
  ...
  <head>
    ...
    <title>Settings Checkout - eCommerce | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                  ...
                  <div class="tab-content p-0">
                    ...
                    <div class="tab-pane fade show active" id="checkout" role="tabpanel">
                      ...
                      <div class="d-flex justify-content-end gap-3">
                        ...
                        <a class="btn btn-primary" href="app-ecommerce-settings-shipping.go">Save</a>
                      </div>
                    </div>
                  </div>
                </div>
