...
<html
  ...
  <head>
    ...
    <title>Settings Shipping &amp; Delivery - eCommerce | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
                ...
                <div class="col-12 col-lg-4">
                  <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                    <ul class="nav nav-align-left nav-pills flex-column">
                      ...
                      <li class="nav-item mb-1">
                        <a class="nav-link" href="app-ecommerce-settings-locations.go">
                  ...
                  <div class="tab-content p-0">
                    ...
                    <div class="tab-pane fade show active" id="shipping_delivery" role="tabpanel">
                      ...
                      <div class="d-flex justify-content-end gap-3">
                        ...
                        <a class="btn btn-primary" href="app-ecommerce-settings-locations.go">Save</a>
                      </div>
                    </div>
                  </div>
                  <!-- /Options-->
