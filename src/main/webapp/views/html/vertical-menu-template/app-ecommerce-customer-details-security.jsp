...
<html
  ...
  <head>
    ...
    <title>eCommerce Customer Details Security - Pages | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
              ...
              <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-4">
                    <li class="nav-item">
                      <a class="nav-link" href="app-ecommerce-customer-details-overview.go"
                        ><i class="bx bx-user me-1"></i>Overview</a
                      >
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="app-ecommerce-customer-details-billing.go"
                        ><i class="bx bx-detail me-1"></i>Address & Billing</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="app-ecommerce-customer-details-notifications.go"
                        ...
                        <tbody>
                          <tr>
                            <td class="text-truncate">
                              <i class="bx bxl-windows text-info me-3"></i> Chrome on Windows
                            </td>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="bx bx-mobile-alt text-danger me-3"></i> Chrome on iPhone
                            </td>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="bx bxl-android text-success me-3"></i> Chrome on Android
                            </td>
