                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="alert alert-primary alert-dismissible" role="alert">
                        ...
                        <p class="mb-0">Bonbon sweet roll dragÃ©e lemon drops tart.</p>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                      <div class="alert alert-secondary alert-dismissible" role="alert">
                    ...
                    <div class="card-body">
                      <div class="alert alert-primary d-flex" role="alert">
                        ...
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">For a watch</h6>
                          <span>This is a primary solid alert â check it out!</span>
                        </div>
                      </div>
                      ...
                      <div class="alert alert-secondary d-flex" role="alert">
                        ...
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Alert Heading</h6>
                          <span>This is a secondary solid alert â check it out!</span>
                        </div>
                      </div>
                      ...
                      <div class="alert alert-success d-flex" role="alert">
                        ...
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Well done :)</h6>
                          <span>This is a success solid alert â check it out!</span>
                        </div>
                      </div>
                      ...
                      <div class="alert alert-danger d-flex" role="alert">
                        ...
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Error!!</h6>
                          <span>This is a danger solid alert â check it out!</span>
                        </div>
                      </div>
                      ...
                      <div class="alert alert-warning d-flex" role="alert">
                        ...
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Be Aware!!</h6>
                          <span>This is a warning solid alert â check it out!</span>
                        </div>
                      </div>

                      <div class="alert alert-info d-flex" role="alert">
                        <span class="badge badge-center rounded-pill bg-info border-label-info p-3 me-2"
                          ><i class="bx bx-detail fs-6"></i
                        ></span>
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Alert!!</h6>
                          <span>This is an info solid alert â check it out!</span>
                        </div>
                      </div>

                      <div class="alert alert-dark d-flex mb-0" role="alert">
                        <span class="badge badge-center rounded-pill bg-dark border-label-dark p-3 me-2"
                          ><i class="bx bx-save fs-6"></i
                        ></span>
                        <div class="d-flex flex-column ps-1">
                          <h6 class="alert-heading d-flex align-items-center mb-1">Be Aware!!</h6>
                          <span>This is a dark solid alert â check it out!</span>
                        </div>
                      </div>
                    </div>
                  </div>
