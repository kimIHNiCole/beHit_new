                    ...
                    <div class="row gy-4 gy-sm-1">
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h3 class="mb-1 red">${workdetail.totalhour}</h3>
                            <p class="mb-0">총 연차</p>
                          </div>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h3 class="mb-1 red">${workdetail.usehour}</h3>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h3 class="mb-1 red">${workdetail.remainhour}</h3>
                    ...
                    <div class="row gy-4 gy-sm-1">
                      <div class="col-sm-6 col-lg-3">
                        <div
                          class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                          <div>
                            <h3 class="mb-1">${workdetail.yearhour}</h3>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                          <div>
                            <h3 class="mb-1">${workdetail.monthhour}</h3>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                          <div>
                            <h3 class="mb-1">${workdetail.overhour}</h3>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                          <div>
                            <h3 class="mb-1">${workdetail.createhour}</h3>
