...
<html
  ...
  <body>
    ...
    <div class="container flex-grow-1 container-p-y my-2">
      <h3>Thank you for purchasing Sneat! ð</h3>
      <p>
        ...
        <div class="col-12 mb-3">
          <div class="card">
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><a href="html/vertical-menu-template/index.go" target="_blank">Vertical Menu Template</a></td>
                  <td>
                    <a href="html-starter/vertical-menu-template/index.go" target="_blank">Vertical Menu Template</a>
                  </td>
                </tr>
                <tr>
                  <td>
                    <a href="html/vertical-menu-template-no-customizer/index.go" target="_blank"
                      >Vertical Menu Template</a
                    >
                    (Without Customizer)
                  </td>
                  <td>
                    <a href="html-starter/vertical-menu-template-no-customizer/index.go" target="_blank"
                      >Vertical Menu Template</a
                    >
                    (Without Customizer)
                  </td>
                ...
                <tr>
                  <td>
                    <a href="html/horizontal-menu-template/index.go" target="_blank">Horizontal Menu Template</a>
                  </td>
                  <td>
                    <a href="html-starter/horizontal-menu-template/index.go" target="_blank"
                ...
                <tr>
                  <td>
                    <a href="html/horizontal-menu-template-no-customizer/index.go" target="_blank"
                      >Horizontal Menu Template</a
                    >
                    (Without Customizer)
                  </td>
                  <td>
                    <a href="html-starter/horizontal-menu-template-no-customizer/index.go" target="_blank"
                      >Horizontal Menu Template</a
                    >
                    (Without Customizer)
                  </td>
                ...
                <tr>
                  <td>
                    <a href="html/front-pages/landing-page.go" target="_blank">Front Pages</a>
                  </td>
                  <td>-</td>
                </tr>
                <tr>
                  <td>
                    <a href="html/front-pages-no-customizer/landing-page.go" target="_blank">Front Pages</a>
                    (Without Customizer)
                  </td>
                  <td>-</td>
                </tr>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/changelog.go"
                      target="_blank"
                      >https://demos.themeselection.com/sneat-bootstrap-html-admin-template/changelog.go</a
                    >
                  </td>
                </tr>
