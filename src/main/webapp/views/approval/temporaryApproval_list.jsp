    ...
    $(function () {
        ...
        if (getApprovalListTable.length) {
            getApprovalListTable.DataTable({
                ...
                ajax: {
                    url: '/approval/temporaryApproval_list.do',
                    type: 'GET',
                    dataSrc: ''
                },
                columns: [
                    ...
                    { 
                        data: 'apv_subject',
                        render: function (data, type, row) {
                            return '<a class="apv-subject-link" data-apv-idx="' + row.apv_idx 
                            	+ '" href="javascript:void(0);" onclick="handleSubjectClick(\'' + row.apv_idx
                            	+ '\', \'' + data + '\');">' 
                            	+ (data === null ? '<span class="null-message">임시저장한 문서입니다</span>' : data) + '</a>';
                        }
                    },
                    { data: 'apv_date' },
                    { 
                ...
                initComplete: function () {
                    ...
                    getApprovalListTable.find('.apv-subject-link').on('click', function (e) {
                        ...
                        window.location.href = '/approval/temporaryApproval_detail.go/'+ apvIdx;
                    });
                }
            });
        }
