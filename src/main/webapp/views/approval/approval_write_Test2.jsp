		 ...
		 // AJAX를 이용하여 페이지 내용 가져오기
		    $.ajax({
            	...
            	method: 'GET',
		        	success: function (data){
			            ...
			            previewWindow.document.write('$(".#snow-editor").html('+$snow_editor+');');
			            previewWindow.document.write('<\/script>');
		    ...
		    /* $.ajax({
		        ...
		        data: {
		            ...
		            'apv_date': $date,
		            'apv_idx': $number,
		            'form_vac_time': $form_vac_time,
		            'apv_start_day': $form_vac_time_start,
		            'apv_end_day': $form_vac_time_end,
		            'apv_cnt': $snow_editor
		        },
		        dataType:'JSON',
		        success: function (data) {
