...
<html
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div style="width:20px;" class="d-flex position-relative pe-0 align-items-center justify-content-center">
                <!-- 여기에 라디오 버튼 추가 -->
    ...
    <script src="../../assets/vendor/libs/dropzone/dropzone.js"></script> <!-- 이미지 드랍 -->
